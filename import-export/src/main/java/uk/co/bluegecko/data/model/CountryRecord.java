...
public record CountryRecord(String code, String name, String nativeName, String phone, String continent,
                            String capital, Set<String> currencies, Set<String> languages) implements Country {
	...
	public static Function<String[], CountryRecord> converter() {
		return s -> new CountryRecord(s[0], s[1], s[2], s[3], s[4], s[5], toSet(s[6]), toSet(s[7]));
	}
